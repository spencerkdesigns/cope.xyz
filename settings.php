...
<head>
    ...
    //                        }
        ...
        <div class="container-fluid settings" style="background-color: #ff5317; margin-top: 90px;">
            <div class="container">
                <form action="settings.php" method="get" role="form">
...
<!--                                <th>Phone Number</th>
                        ...
                        <tbody>
                            <tr>
                                <?php
                                $connection = mysql_connect("50.62.209.118", "spencer", "QweQwe3!2");
                                $mysql_select_db("cope_");

                                $query = "SELECT * FROM fgusers3";
                                $result = mysql_query($query);
                                
                                while($row = mysql_fetch_array($result)){
                                    echo "<td>" . $row['name'] . "</td><td>" . $row['email'] . "</td><td>" . $row['phone_number'] . "</td><td>" . $row['address'] . "</td><td>" . $row['username'] . "</td><td>" . $row['password'];
                                }
                                mysql_close();
                                ?>
                            </tr>
            ...
            <div class="container-fluid" style="height: 20em;"></div>
        </div>
